...
- Danielle provided access to twitter and shared information about the last hootsuite schedule:
	- If you don't already have it, I'll send along the log in information for the Twitter account @CarpentryCon (apologies for not sending it here, I've forgotten the password and need to go through the process of recovering that -_- ). I can also share a spreadsheet I used to keep track of the tweets that were scheduled (using Hootsuite) for the last 50 days leading up to the conference; it was a mix of introducing people, sharing facts about the conference location, sneak peaks of conference sessions, etc. It isn't as complete as it should be; I ended up doing more "on the fly" than I had intended, but might be a good place to start -> https://docs.google.com/spreadsheets/d/1_DKp8Gh6urElWmk3eQkRHkD6C0HY2hszaT_2or9mXIo/edit?usp=sharing
